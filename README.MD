# [HTML5 Boilerplate](https://html5boilerplate.com/) rewritten with [Pug](https://github.com/pugjs/pug), [Stylus](https://github.com/stylus/stylus) and [CoffeeScript](https://github.com/jashkenas/coffeescript).
...
1. Clone the gut repo — `git clone https://github.com/M-O-Z-G/bp6psc.git`
2. [Install Yarn](https://yarnpkg.com/en/docs/install)
3. Run `yarn install` from your project folder.
3. Run `gulp` to compile project.
...
* Social Metatags included as separate block-file `_metaSocial.pug` (this is bonus, not a part of original HTML5 Boilerplate)
